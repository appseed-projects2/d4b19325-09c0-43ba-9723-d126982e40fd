...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-26 09:22`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d4b19325-09c0-43ba-9723-d126982e40fd.git
$ cd d4b19325-09c0-43ba-9723-d126982e40fd
```
